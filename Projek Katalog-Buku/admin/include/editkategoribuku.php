    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="index.php?include=kategori-buku.php" class="btn btn-sm btn-warning float-right"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
        </div>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
...
action="index.php?include=konfirmasi-edit-kategori-buku">
  <div class="card-body">
    <div class="form-group row">
      ...
      <div class="col-sm-7">
          ...
          id="kategori_buku" value="<?php echo $kategori_buku;?>">
      </div>
    </div>
  </div>
  <!-- /.card-body -->
